...
class GestionAbonos extends StatefulWidget  {
  GestionAbonos(this.index,this.data,this.EstadoAtrasoColor);
  final int index;
  ...
  @override
  GestionAbonosState createState() {
    return new GestionAbonosState();
  }
}
...
class GestionAbonosState extends State<GestionAbonos> {
              ...
              child: new ListView(
                children: <Widget>[
                  ...
                  new ListTile(
                    ...
                    title: new DropdownButton<Par_condicion>(
